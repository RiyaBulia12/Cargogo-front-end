          ...
          <div className="lg:flex lg:flex-wrap g-0">
            ...
            <div
              ...
              <div className="text-white px-4 py-6 md:p-12 md:mx-6">
                  <img src="https://images.unsplash.com/photo-1522932467653-e48f79727abf?ixlib=rb-4.0.3&ixid=MnwxM[…]G90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=830&q=80" alt="CarImage" />
              </div>
            </div>
          </div>
        </div>
