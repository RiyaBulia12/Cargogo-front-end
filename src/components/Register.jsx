                ...
                <div className="lg:w-6/12 px-4 md:px-0">
                 ...
                 <div className="lg:w-6/12 flex items-center lg:rounded-r-lg rounded-b-lg lg:rounded-bl-none lg:block hidden">
                  <div className="text-white px-4 py-6 md:p-12 md:mx-6">
                    ...
                    <img src="https://images.unsplash.com/photo-1522932467653-e48f79727abf?ixlib=rb-4.0.3&ixid=MnwxM[…]G90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=830&q=80"
                    alt="SideImage"/>
                  </div>
                </div>
              </div>
